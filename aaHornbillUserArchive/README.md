# Hornbill User Archive - Azure Automation Powershell Workflow Runbook

## Description

This is an Azure Automation Powershell Workflow Runbook which will archive a user on a Hornbill instance.
