# Hornbill Workspace Create - Azure Automation Powershell Workflow Runbook

## Description

This is an Azure Automation Powershell Workflow Runbook which will create a workspace on a Hornbill instance.
