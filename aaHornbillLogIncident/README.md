# Hornbill Log Incident - Azure Automation Powershell Workflow Runbook

## Description

This is an Azure Automation Powershell Workflow Runbook which will Log a new Incident within Service Manager on a Hornbill instance.
