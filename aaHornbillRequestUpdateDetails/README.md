# Hornbill Update Request Details - Azure Automation Powershell Workflow Runbook

## Description

This is an Azure Automation Powershell Workflow Runbook which will update the details of a Request within Service Manager on a Hornbill instance.
