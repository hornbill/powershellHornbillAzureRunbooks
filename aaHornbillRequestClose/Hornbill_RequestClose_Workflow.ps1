##############################
#.SYNOPSIS
#Azure Powershell Workflow Runbook to close a request within Service Manager on a Hornbill Instance
#
#.DESCRIPTION
#Azure Powershell Runbook to close a request within Service Manager on a Hornbill Instance
#
