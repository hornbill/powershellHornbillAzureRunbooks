# Hornbill User Create - Azure Automation Powershell Workflow Runbook

## Description

This is an Azure Automation Powershell Workflow Runbook which will create a user on a Hornbill instance.
